...
introDiv.innerHTML = `
    <h2>🧠 关于 WeGPT 推荐值</h2
    <p>WeGPT 推荐值是由人工智能大模型基于新闻内容质量、技术实用性、新闻热度、行业热点趋势与内容创新性等多个维度动态计算的新闻价值参考分。</p>
    <p><strong>核心优势：</strong><br>
    高 WeGPT 推荐值 → 新闻重要性高、内容可信、传播价值强<br>
    低 WeGPT 推荐值 → 新闻价值一般，可快速筛选
    </p>
    <p>当前为试运行阶段，WeGPT 推荐值可帮助您快速了解新闻的重要性与可信度，未来会进一步优化权重与智能判断逻辑。</p>
`;
